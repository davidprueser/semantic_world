...
class Vector3MappingDAO(
    Base, DataAccessObject[semantic_world.orm.model.Vector3Mapping]
):
...
class RotationMatrixMappingDAO(
    Base, DataAccessObject[semantic_world.orm.model.RotationMatrixMapping]
):
...
class SpatialRelationDAO(
    Base, DataAccessObject[semantic_world.reasoning.predicates.SpatialRelation]
):
    ...
    other: Mapped[BodyDAO] = relationship(
        "BodyDAO", uselist=False, foreign_keys=[other_id], post_update=True
    )
...
class ContainsTypeDAO(
    Base, DataAccessObject[semantic_world.reasoning.predicates.ContainsType]
):
...
class WorldEntityDAO(
    Base, DataAccessObject[semantic_world.world_description.world_entity.WorldEntity]
):
...
class ShapeCollectionDAO(
    Base,
    DataAccessObject[semantic_world.world_description.shape_collection.ShapeCollection],
):
...
class FieldOfViewDAO(
    Base, DataAccessObject[semantic_world.robots.abstract_robot.FieldOfView]
):
...
class TransformationMatrixMappingDAO(
    Base, DataAccessObject[semantic_world.orm.model.TransformationMatrixMapping]
):
...
class CollisionCheckingConfigDAO(
    Base,
    DataAccessObject[
        semantic_world.world_description.world_entity.CollisionCheckingConfig
    ],
):
...
class BoundingBoxDAO(
    Base, DataAccessObject[semantic_world.world_description.geometry.BoundingBox]
):
...
class WorldMappingDAO(Base, DataAccessObject[semantic_world.orm.model.WorldMapping]):
    ...
    views: Mapped[List[ViewDAO]] = relationship(
        "ViewDAO", foreign_keys="[ViewDAO.worldmappingdao_views_id]", post_update=True
    )
...
class PrefixedNameDAO(
    Base, DataAccessObject[semantic_world.datastructures.prefixed_name.PrefixedName]
):
...
class QuaternionMappingDAO(
    Base, DataAccessObject[semantic_world.orm.model.QuaternionMapping]
):
...
class InsideOfDAO(
    SpatialRelationDAO, DataAccessObject[semantic_world.reasoning.predicates.InsideOf]
):
...
class ViewDependentSpatialRelationDAO(
    SpatialRelationDAO,
    DataAccessObject[semantic_world.reasoning.predicates.ViewDependentSpatialRelation],
):
    ...
    point_of_view: Mapped[TransformationMatrixMappingDAO] = relationship(
        "TransformationMatrixMappingDAO",
        uselist=False,
...
class CylinderDAO(
    ShapeDAO, DataAccessObject[semantic_world.world_description.geometry.Cylinder]
):
...
class SphereDAO(
    ShapeDAO, DataAccessObject[semantic_world.world_description.geometry.Sphere]
):
...
class KinematicStructureEntityDAO(
    WorldEntityDAO,
    DataAccessObject[
        semantic_world.world_description.world_entity.KinematicStructureEntity
    ],
):
...
class DegreeOfFreedomMappingDAO(
    WorldEntityDAO, DataAccessObject[semantic_world.orm.model.DegreeOfFreedomMapping]
):
...
class ConnectionDAO(
    WorldEntityDAO,
    DataAccessObject[semantic_world.world_description.world_entity.Connection],
):
...
class ViewDAO(
    WorldEntityDAO, DataAccessObject[semantic_world.world_description.world_entity.View]
):
    __tablename__ = "ViewDAO"

    id: Mapped[int] = mapped_column(ForeignKey(WorldEntityDAO.id), primary_key=True)

    worldmappingdao_views_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("WorldMappingDAO.id", use_alter=True), nullable=True
    )
...
class BelowDAO(
    ...
    DataAccessObject[semantic_world.reasoning.predicates.Below],
):
    __tablename__ = "BelowDAO"

    id: Mapped[int] = mapped_column(
        ForeignKey(ViewDependentSpatialRelationDAO.id), primary_key=True
    )
...
class InFrontOfDAO(
    ViewDependentSpatialRelationDAO,
    DataAccessObject[semantic_world.reasoning.predicates.InFrontOf],
):
...
class RightOfDAO(
    ViewDependentSpatialRelationDAO,
    DataAccessObject[semantic_world.reasoning.predicates.RightOf],
):
...
class BehindDAO(
    ViewDependentSpatialRelationDAO,
    DataAccessObject[semantic_world.reasoning.predicates.Behind],
):
...
class LeftOfDAO(
    ViewDependentSpatialRelationDAO,
    DataAccessObject[semantic_world.reasoning.predicates.LeftOf],
):
...
class AboveDAO(
    ViewDependentSpatialRelationDAO,
    DataAccessObject[semantic_world.reasoning.predicates.Above],
):
...
class FileMeshDAO(
    MeshDAO, DataAccessObject[semantic_world.world_description.geometry.FileMesh]
):
...
class TriangleMeshDAO(
    MeshDAO, DataAccessObject[semantic_world.world_description.geometry.TriangleMesh]
):
    __tablename__ = "TriangleMeshDAO"

    id: Mapped[int] = mapped_column(ForeignKey(MeshDAO.id), primary_key=True)

    mesh: Mapped[Optional[semantic_world.orm.model.TrimeshType]] = mapped_column(
        semantic_world.orm.model.TrimeshType, nullable=True
    )
...
class BodyDAO(
    KinematicStructureEntityDAO,
    DataAccessObject[semantic_world.world_description.world_entity.Body],
):
...
class RegionDAO(
    KinematicStructureEntityDAO,
    DataAccessObject[semantic_world.world_description.world_entity.Region],
):
...
class PassiveConnectionDAO(
    ConnectionDAO,
    DataAccessObject[semantic_world.world_description.connections.PassiveConnection],
):
...
class ActiveConnectionDAO(
    ConnectionDAO,
    DataAccessObject[semantic_world.world_description.connections.ActiveConnection],
):
...
class FixedConnectionDAO(
    ConnectionDAO,
    DataAccessObject[semantic_world.world_description.connections.FixedConnection],
):
...
class RootedViewDAO(
    ViewDAO, DataAccessObject[semantic_world.world_description.world_entity.RootedView]
):
...
class RoomDAO(ViewDAO, DataAccessObject[semantic_world.views.views.Room]):
    ...
    floor_id: Mapped[int] = mapped_column(
        ForeignKey("FloorSurfaceDAO.id", use_alter=True), nullable=True
    )

    floor: Mapped[FloorSurfaceDAO] = relationship(
        "FloorSurfaceDAO", uselist=False, foreign_keys=[floor_id], post_update=True
    )
...
class FridgeDAO(ViewDAO, DataAccessObject[semantic_world.views.views.Fridge]):
    ...
    doors: Mapped[List[DoorDAO]] = relationship(
        "DoorDAO", foreign_keys="[DoorDAO.fridgedao_doors_id]", post_update=True
    )
...
class HouseholdObjectDAO(
    ViewDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.HouseholdObject],
):
...
class TableDAO(ViewDAO, DataAccessObject[semantic_world.views.views.Table]):
    ...
    table_top_surface_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("TableTopSurfaceDAO.id", use_alter=True), nullable=True
    )

    body: Mapped[BodyDAO] = relationship(
        "BodyDAO", uselist=False, foreign_keys=[body_id], post_update=True
    )
    table_top_surface: Mapped[TableTopSurfaceDAO] = relationship(
        "TableTopSurfaceDAO",
        uselist=False,
        foreign_keys=[table_top_surface_id],
        post_update=True,
    )
...
class SupportingSurfaceDAO(
    ViewDAO, DataAccessObject[semantic_world.views.views.SupportingSurface]
):
...
class Connection6DoFDAO(
    ...
    DataAccessObject[semantic_world.world_description.connections.Connection6DoF],
):
...
class OmniDriveDAO(
    ActiveConnectionDAO,
    DataAccessObject[semantic_world.world_description.connections.OmniDrive],
):
...
class ActiveConnection1DOFDAO(
    ActiveConnectionDAO,
    DataAccessObject[semantic_world.world_description.connections.ActiveConnection1DOF],
):
...
class RobotViewDAO(
    RootedViewDAO, DataAccessObject[semantic_world.robots.abstract_robot.RobotView]
):
...
class EnvironmentViewDAO(
    RootedViewDAO,
    DataAccessObject[semantic_world.world_description.world_entity.EnvironmentView],
):
...
class AbstractRobotDAO(
    RootedViewDAO, DataAccessObject[semantic_world.robots.abstract_robot.AbstractRobot]
):
...
class BedDAO(
    FurnitureDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Bed]
):
...
class ShelvingUnitDAO(
    FurnitureDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.ShelvingUnit],
):
...
class ChairDAO(
    FurnitureDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Chair],
):
...
class SofaDAO(
    FurnitureDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Sofa]
):
...
class BowlDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Bowl],
):
...
class BookFrontDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.BookFront],
):
...
class DroneDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Drone],
):
...
class SprayBottleDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.SprayBottle],
):
...
class PenDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Pen],
):
...
class ClothDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Cloth],
):
...
class BookDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Book],
):
    __tablename__ = "BookDAO"

    id: Mapped[int] = mapped_column(ForeignKey(HouseholdObjectDAO.id), primary_key=True)

    book_front_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("BookFrontDAO.id", use_alter=True), nullable=True
    )
...
class LiquidCapDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.LiquidCap],
):
...
class HouseplantDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Houseplant],
):
...
class WallPanelDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.WallPanel],
):
...
class SaltPepperShakerDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.SaltPepperShaker],
):
...
class CuttleryDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Cuttlery],
):
...
class PlateDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Plate],
):
...
class SinkDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Sink],
):
...
class VaseDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Vase],
):
...
class FoodDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Food],
):
...
class DecorDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Decor],
):
...
class PencilDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Pencil],
):
...
class BaseballDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Baseball],
):
...
class StatueDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Statue],
):
...
class LidDAO(
    HouseholdObjectDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Lid],
):
...
class BottleDAO(
    ContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Bottle],
):
...
class CookingContainerDAO(
    ContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.CookingContainer],
):
...
class ProcthorBoxDAO(
    ContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.ProcthorBox],
):
...
class GarbageBinDAO(
    ContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.GarbageBin],
):
...
class DrinkingContainerDAO(
    ContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.DrinkingContainer],
):
...
class DiningTableDAO(
    TableDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.DiningTable],
):
...
class DeskDAO(
    TableDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Desk]
):
...
class SideTableDAO(
    TableDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.SideTable],
):
...
class CoffeeTableDAO(
    TableDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.CoffeeTable],
):
...
class SofaSurfaceDAO(
    SupportingSurfaceDAO, DataAccessObject[semantic_world.views.views.SofaSurface]
):
...
class DrawerSurfaceDAO(
    SupportingSurfaceDAO, DataAccessObject[semantic_world.views.views.DrawerSurface]
):
...
class TableTopSurfaceDAO(
    SupportingSurfaceDAO, DataAccessObject[semantic_world.views.views.TableTopSurface]
):
...
class FloorSurfaceDAO(
    SupportingSurfaceDAO, DataAccessObject[semantic_world.views.views.FloorSurface]
):
...
class PrismaticConnectionDAO(
    ...
    DataAccessObject[semantic_world.world_description.connections.PrismaticConnection],
):
...
class RevoluteConnectionDAO(
    ActiveConnection1DOFDAO,
    DataAccessObject[semantic_world.world_description.connections.RevoluteConnection],
):
...
class KinematicChainDAO(
    RobotViewDAO, DataAccessObject[semantic_world.robots.abstract_robot.KinematicChain]
):
...
class SensorDAO(
    RobotViewDAO, DataAccessObject[semantic_world.robots.abstract_robot.Sensor]
):
...
class ManipulatorDAO(
    RobotViewDAO, DataAccessObject[semantic_world.robots.abstract_robot.Manipulator]
):
...
class OfficeChairDAO(
    ChairDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.OfficeChair],
):
...
class ArmchairDAO(
    ChairDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Armchair]
):
...
class ForkDAO(
    CuttleryDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Fork]
):
...
class SpoonDAO(
    CuttleryDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Spoon]
):
...
class KnifeDAO(
    CuttleryDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Knife]
):
...
class TunaCanDAO(
    FoodDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.TunaCan]
):
...
class CheezeItDAO(
    FoodDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.CheezeIt]
):
...
class ProduceDAO(
    FoodDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Produce]
):
...
class GelatinBoxDAO(
    FoodDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.GelatinBox],
):
...
class BreadDAO(
    FoodDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Bread]
):
...
class TomatoSoupDAO(
    FoodDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.TomatoSoup],
):
...
class PringlesDAO(
    FoodDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Pringles]
):
...
class WallDecorDAO(
    DecorDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.WallDecor],
):
...
class PanLidDAO(
    LidDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.PanLid]
):
...
class PotLidDAO(
    LidDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.PotLid]
):
...
class SoapBottleDAO(
    BottleDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.SoapBottle],
):
...
class MustardBottleDAO(
    BottleDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.MustardBottle],
):
...
class WineBottleDAO(
    BottleDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.WineBottle],
):
...
class KettleDAO(
    CookingContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Kettle],
):
    __tablename__ = "KettleDAO"

    id: Mapped[int] = mapped_column(
        ForeignKey(CookingContainerDAO.id), primary_key=True
    )
...
class PotDAO(
    CookingContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Pot],
):
...
class PanDAO(
    CookingContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Pan],
):
...
class CupDAO(
    ...
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Cup],
):
    __tablename__ = "CupDAO"

    id: Mapped[int] = mapped_column(
        ForeignKey(DrinkingContainerDAO.id), primary_key=True
    )
...
class MugDAO(
    DrinkingContainerDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Mug],
):
...
class DoubleDoorDAO(
    EntryWayDAO, DataAccessObject[semantic_world.views.views.DoubleDoor]
):
    ...
    doors: Mapped[List[DoorDAO]] = relationship(
        "DoorDAO", foreign_keys="[DoorDAO.doubledoordao_doors_id]", post_update=True
    )
...
class DoorDAO(EntryWayDAO, DataAccessObject[semantic_world.views.views.Door]):
    ...
    fridgedao_doors_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("FridgeDAO.id", use_alter=True), nullable=True
    )
    ...
    doubledoordao_doors_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("DoubleDoorDAO.id", use_alter=True), nullable=True
    )
    handle_id: Mapped[int] = mapped_column(
        ForeignKey("HandleDAO.id", use_alter=True), nullable=True
    )
...
class ArmDAO(
    KinematicChainDAO, DataAccessObject[semantic_world.robots.abstract_robot.Arm]
):
...
class NeckDAO(
    KinematicChainDAO, DataAccessObject[semantic_world.robots.abstract_robot.Neck]
):
...
class TorsoDAO(
    KinematicChainDAO, DataAccessObject[semantic_world.robots.abstract_robot.Torso]
):
...
class FingerDAO(
    KinematicChainDAO, DataAccessObject[semantic_world.robots.abstract_robot.Finger]
):
...
class CameraDAO(
    SensorDAO, DataAccessObject[semantic_world.robots.abstract_robot.Camera]
):
...
class ParallelGripperDAO(
    ManipulatorDAO,
    DataAccessObject[semantic_world.robots.abstract_robot.ParallelGripper],
):
...
class AppleDAO(
    ProduceDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Apple]
):
...
class OrangeDAO(
    ProduceDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Orange]
):
...
class PotatoDAO(
    ProduceDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Potato]
):
...
class LettuceDAO(
    ProduceDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Lettuce],
):
...
class BananaDAO(
    ProduceDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Banana]
):
...
class TomatoDAO(
    ProduceDAO, DataAccessObject[semantic_world.adapters.procthor.procthor_views.Tomato]
):
...
class PosterDAO(
    WallDecorDAO,
    DataAccessObject[semantic_world.adapters.procthor.procthor_views.Poster],
):
